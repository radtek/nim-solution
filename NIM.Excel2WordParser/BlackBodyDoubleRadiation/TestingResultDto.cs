...
namespace NIM.CertificationGenerator.BlackBodyDoubleRadiation
{
    ...
    public class TestingProcessResultDto : ITestingResultDto, IAdvanceValue
    {
        ...
        public List<double> T1Temperatures
        {
            get; set;
        }
        [WordKey(Key = "{{t2v}}")]
        ...
        public List<double> T2Temperatures
        {
            get; set;
        }
    ...
    public class TestinStatisticsDto
    {
        ...
        public TestinStatisticsDto()
        {
            this.T1亮度温度 = this.T1U值 =
                this.T2亮度温度 = this.T2U值 = EMPTY;
        }
