...
namespace NIM.CertificationGenerator.BlackBodySurfaceRadiation
{
    ...
    {
        [WordKey]
        [SimpleExcelMaping("证书编号", ExcelAddressName = "汇总:M3")]
        public string CertificationNo
        {
            get; set;
        }
        [WordKey]
        [SimpleExcelMaping("客户名称", ExcelAddressName = "汇总:M6")]
        ...
        [WordKey]
        [SimpleExcelMaping("客户地址", ExcelAddressName = "汇总:M7")]
        public string CustomerAddress
        {
            get; set;
        }

        [SimpleExcelMaping("校准日期", ExcelAddressName = "汇总:H3")]
        ...
        [WordKey(Key = "{{TT}}")]
        [SimpleExcelMaping("环境温度", ExcelAddressName = "汇总:H6")]
        ...
        /// 测试环境温度
        /// </summary>
        [SimpleExcelMaping("环境湿度", ExcelAddressName = "汇总:H7")]
        public string THumidity
        {
            get; set;
        }
        [WordKey]
        [SimpleExcelMaping("校准地点", ExcelAddressName = "汇总:H4")]
        ...
        //public List<string> AccordingByConditions
        //{
        //    get; set;
        //}
